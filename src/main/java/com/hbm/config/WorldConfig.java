...
public class WorldConfig {
	...
	public static int epsteiniumSpawn = 1;
	...
	public static void loadFromConfig(Configuration config) {
		...
		epsteiniumSpawn = CommonConfig.createConfigInt(config, CATEGORY_OREGEN, "2.47_epsteiniumSpawnrate", "Amount of epsteinium ore veins per chunk", 10);
		...
		newBedrockOres = CommonConfig.createConfigBool(config, CATEGORY_OREGEN, "2.NB_newBedrockOres", "Enables the newer genreric bedrock ores", false);
